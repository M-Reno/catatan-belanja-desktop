# views/budget_page.py — Placeholder Budget (Tahap 4)
import sqlite3
...
class BudgetPage(ctk.CTkFrame):
    ...
    def _buat_header(self):
        ...
        ctk.CTkLabel(frame, text="Budget", font=get_font("heading_1"),
                     text_color=TEXT_PRIMARY, anchor="w").pack(anchor="w")

    def _buat_konten(self):
        frame = ctk.CTkFrame(self, fg_color="transparent")
        frame.grid(row=1, column=0)
        ctk.CTkLabel(frame, text="Form budget akan diimplementasi di Tahap 6.",
