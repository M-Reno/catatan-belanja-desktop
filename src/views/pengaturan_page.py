# views/pengaturan_page.py — Placeholder Pengaturan (Tahap 4)
import sqlite3
...
class PengaturanPage(ctk.CTkFrame):
    ...
    def _buat_header(self):
        ...
        ctk.CTkLabel(frame, text="Pengaturan", font=get_font("heading_1"),
                     text_color=TEXT_PRIMARY, anchor="w").pack(anchor="w")

    def _buat_konten(self):
        frame = ctk.CTkFrame(self, fg_color="transparent")
        frame.grid(row=1, column=0)
        ctk.CTkLabel(frame, text="CRUD Satuan & Kategori akan diimplementasi di Tahap 5.",
